...
![Интерфейс Swagger UI](4dev/image-1.png)
![Логи работы приложения и CRUD операций](4dev/image-2.png)

## Отчёт по рефакторингу

[Ознакомиться с полным отчётом по исправлению багов](./4dev/report.md)
