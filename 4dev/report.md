...
Глядя на Next wakeup is due in 299.99 seconds, подтверждаю, что баг с интервалом планировщика (seconds vs minutes) полностью устранен. Логи HTTP-запросов (201, 200, 204) подтверждают корректную работу CRUD-слоя после рефакторинга схем.